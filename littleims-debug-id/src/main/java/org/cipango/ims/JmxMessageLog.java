...
public class JmxMessageLog extends org.cipango.callflow.JmxMessageLog
{
	...
	public JmxMessageLog()
	{
		...
		addAlias("scscf", "S-CSCF");
		addAlias("icscf", "I-CSCF");
		addAlias("bgcg", "B-CSCF");
	}
	
	public void addAlias(String prefix, String name)
	{
		try
		{
			addAlias(System.getProperty(prefix + ".host"), 
					Integer.parseInt(System.getProperty(prefix + ".sip.port")), 
					name);
		}
		catch (Exception e)
		{
