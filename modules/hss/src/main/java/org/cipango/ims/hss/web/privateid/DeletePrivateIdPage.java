...
public class DeletePrivateIdPage extends PrivateIdentityPage {
	...
	public DeletePrivateIdPage(PageParameters pageParameters) {
		...
		add(new Label("delete.confirm", 
				getString(getPrefix() + ".delete.confirm", new DaoDetachableModel(privateIdentity))));
		...
		form.add(new Button("delete") {
			public void onSubmit() {
				PrivateIdentity id = _dao.findById(key);
